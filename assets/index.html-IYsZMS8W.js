import{_ as n,c as a,a as e,o as i}from"./app-BVG6Y2mK.js";const l={};function d(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h2 id="_1-部署并验证-redis-服务" tabindex="-1"><a class="header-anchor" href="#_1-部署并验证-redis-服务"><span>1.部署并验证 Redis 服务</span></a></h2><p>本任务是在docker上安装redis，并运行redis容器。实施步骤如下所示。</p><p>1）拉取redis:6.0.9</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#393a34;--shiki-dark:#dbd7caee;--shiki-light-bg:#ffffff;--shiki-dark-bg:#121212;"><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code class="language-"><span class="line"><span>root@hp-None:~# docker pull redis:6.0.9</span></span>
...
<span class="line"><span>root@hp-None:~# docker run -p 6379:6379 -d --name redis03 --restart=always -v /root/redisdata:/data redis:6.0.9 redis-server --appendonly yes</span></span>
<span class="line"><span>834a021d5e54be1021e780cb3351c0a6b2053db7e58307407cc9c31de4c958d2</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>查看redis是否还有之前的数据。</p>`,92)]))}const c=n(l,[["render",d]]),t=JSON.parse('{"path":"/article/7lgm1r7j/","title":"部署并验证 Redis 服务","lang":"zh-CN","frontmatter":{"title":"部署并验证 Redis 服务","createTime":"2025/08/05 09:25:24","permalink":"/article/7lgm1r7j/"},"readingTime":{"minutes":7.29,"words":2188},"git":{"createdTime":1754385901000,"updatedTime":1754385901000,"contributors":[{"name":"elvishehai521@163.com","username":"","email":"elvishehai521@163.com","commits":1,"avatar":"https://gravatar.com/avatar/6a640db68c5bf3768af7413cb28623721edb88b0f88957ed42c162769c5f659c?d=retro"}]},"filePathRelative":"notes/docker/部署并验证 Redis 服务.md","headers":[],"categoryList":[{"id":"4358b5","sort":10000,"name":"notes"},{"id":"154f33","sort":10001,"name":"docker"}]}');export{c as comp,t as data};
